...
//перемещения пересекаются - если двигать объект на основном поле то у трекбара тоже будет двигаться ползунок
...
// в path сделать дополнительную нормализацию. удаление близлежащих точек, что бы улучшить путь
